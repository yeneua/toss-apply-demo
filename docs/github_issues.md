...
이 문서는 `tasks.md`의 작업을 GitHub Issue로 등록하기 위한 템플릿입니다. 각 섹션을 복사하여 이슈로 등록하세요.

---

## Issue 1: 초기 설정 및 환경 구성 (Setup)

**제목:** [Setup] 프로젝트 초기 설정 및 환경 구성
...
## Issue 2: Dropdown / Select 컴포넌트 개발

**제목:** [Feature] Headless Dropdown/Select 컴포넌트 구현
...
## Issue 3: Modal / Dialog 컴포넌트 개발

**제목:** [Feature] 접근성을 준수한 Modal/Dialog 컴포넌트 구현
...
## Issue 4: Tabs 컴포넌트 개발

**제목:** [Feature] Compound Pattern 기반 Tabs 컴포넌트 구현
...
## Issue 5: Accordion 컴포넌트 개발

**제목:** [Feature] Headless Accordion 컴포넌트 구현
...
## Issue 6: Toast / Notification 컴포넌트 개발

**제목:** [Feature] Toast 알림 시스템 구현
...
## Issue 7: Switch / Toggle 및 Tooltip 컴포넌트 개발

**제목:** [Feature] Switch 및 Tooltip 유틸리티 컴포넌트 구현
...
## Issue 8: 문서화 및 배포 (Docs & Deploy)

**제목:** [Docs] 문서화 및 배포 파이프라인 구축
